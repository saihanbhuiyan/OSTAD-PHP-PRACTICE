...
class Module17Class1Controller extends Controller
{
    ...
    // php artisan make:migrate create_dbName_table 
    // 1)sejonno prothpome amra .env thik kore nibo mysql korenibo na korleo hobe but korenibo
    ...
    // *************php artsan migrate:run to add that table in phpmyadmin database*******shudu migrate dileo run korbe
...
// --->ata sudu tokhn e korbo tokhn amn kono lock issue hobe like kono error khaise kono field 
...
// *******akhn ekti database relation toiri korbo tasks o users er modde***********
// users table agei creat chilo naki i will chack
...
// 2)ekti index file creat korte hobe data base a php 
// -->artisan make:migration add_index_to_tasks_table (tahole migration a ekti table 
...
// PUBLIC DOWN() : $table->dropIndex(['name']); index drop kortegele fieldName arrayer modde ditehobe
...
// $table->idaddress()->index();chaile avabe rakhteo pari abr vitore ip_address diteo pari $table->idaddress('ip_address')->index( );
...
// php artisan make:migrate ceate_products_table
...
// decimal er khetre amader dosomiker por koighor jabe ta boleditehobe (8,2)akhane 8 means
// total colum ba ghor hobe 8ti abong dosomiker por ghor hobe 2ti
...
// akhane onDelete('cascade'); kno use hoyeche ta poredekhabe
